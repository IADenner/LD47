...
HXLINE( 150)				_hx_tmp = ::hx::IsNotNull( _positions );
            			}
            			else {
...
HXLINE( 162)						{
HXLINE( 162)							int _g1 = (lastCluster + 1);
HXDLIN( 162)							int _g2 = info->cluster;
HXDLIN( 162)							while((_g1 < _g2)){
HXLINE( 162)								_g1 = (_g1 + 1);
HXDLIN( 162)								int j = (_g1 - 1);
HXLINE( 166)								::Array< ::Dynamic> _hx_tmp = this->get_positions();
HXDLIN( 166)								 ::lime::math::Vector2 _hx_tmp1 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0);
HXDLIN( 166)								_hx_tmp->push( ::openfl::_internal::text::GlyphPosition_obj::__alloc( HX_CTX ,0,_hx_tmp1, ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0)));
            							}
            						}
HXLINE( 169)						::Array< ::Dynamic> _hx_tmp = this->get_positions();
HXDLIN( 169)						int info1 = info->codepoint;
HXDLIN( 169)						 ::lime::math::Vector2 _hx_tmp1 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,((( (Float)(position->xAdvance) ) / ( (Float)(64) )) + this->letterSpacing),(( (Float)(position->yAdvance) ) / ( (Float)(64) )));
HXDLIN( 169)						_hx_tmp->push( ::openfl::_internal::text::GlyphPosition_obj::__alloc( HX_CTX ,info1,_hx_tmp1, ::lime::math::Vector2_obj::__alloc( HX_CTX ,(( (Float)(position->xOffset) ) / ( (Float)(64) )),(( (Float)(position->yOffset) ) / ( (Float)(64) )))));
