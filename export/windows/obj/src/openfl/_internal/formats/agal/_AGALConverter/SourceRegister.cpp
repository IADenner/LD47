...
HX_DEFINE_STACK_FRAME(_hx_pos_c312f67fa56a379a_957_new,"openfl._internal.formats.agal._AGALConverter.SourceRegister","new",0xbda55cf3,"openfl._internal.formats.agal._AGALConverter.SourceRegister.new","openfl/_internal/formats/agal/AGALConverter.hx",957,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_c312f67fa56a379a_975_toGLSL,"openfl._internal.formats.agal._AGALConverter.SourceRegister","toGLSL",0x1060aa46,"openfl._internal.formats.agal._AGALConverter.SourceRegister.toGLSL","openfl/_internal/formats/agal/AGALConverter.hx",975,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_c312f67fa56a379a_960_parse,"openfl._internal.formats.agal._AGALConverter.SourceRegister","parse",0x9b91a786,"openfl._internal.formats.agal._AGALConverter.SourceRegister.parse","openfl/_internal/formats/agal/AGALConverter.hx",960,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_c312f67fa56a379a_945_boot,"openfl._internal.formats.agal._AGALConverter.SourceRegister","boot",0x2b24f83f,"openfl._internal.formats.agal._AGALConverter.SourceRegister.boot","openfl/_internal/formats/agal/AGALConverter.hx",945,0x323dd368)
namespace openfl{
namespace _internal{
namespace formats{
namespace agal{
...
void SourceRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_c312f67fa56a379a_957_new)
            	}
...
::String SourceRegister_obj::toGLSL(::hx::Null< bool >  __o_emitSwizzle,::hx::Null< int >  __o_offset){
            	...
            	HX_STACKFRAME(&_hx_pos_c312f67fa56a379a_975_toGLSL)
HXLINE( 976)		if ((this->type == 3)) {
HXLINE( 978)			if (::hx::IsEq( this->programType,::openfl::_internal::formats::agal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
HXLINE( 978)				return HX_("gl_Position",63,0d,2a,e5);
            			}
            			else {
HXLINE( 978)				return HX_("gl_FragColor",d7,68,e4,21);
            			}
            		}
HXLINE( 981)		bool fullxyzw;
HXDLIN( 981)		if ((this->s == 228)) {
HXLINE( 981)			fullxyzw = (this->sourceMask == 15);
            		}
            		else {
HXLINE( 981)			fullxyzw = false;
            		}
HXLINE( 982)		::String swizzle = HX_("",00,00,00,00);
HXLINE( 984)		bool _hx_tmp;
HXDLIN( 984)		if ((this->type != 5)) {
HXLINE( 984)			_hx_tmp = !(fullxyzw);
            		}
            		else {
HXLINE( 984)			_hx_tmp = false;
            		}
HXDLIN( 984)		if (_hx_tmp) {
HXLINE( 989)			if (((this->sourceMask & 1) != 0)) {
HXLINE( 991)				switch((int)((this->s & 3))){
            					case (int)0: {
HXLINE( 994)						swizzle = (swizzle + HX_("x",78,00,00,00));
            					}
            					break;
            					case (int)1: {
HXLINE( 996)						swizzle = (swizzle + HX_("y",79,00,00,00));
            					}
            					break;
            					case (int)2: {
HXLINE( 998)						swizzle = (swizzle + HX_("z",7a,00,00,00));
            					}
            					break;
            					case (int)3: {
HXLINE(1000)						swizzle = (swizzle + HX_("w",77,00,00,00));
            					}
            					break;
            				}
            			}
HXLINE( 989)			if (((this->sourceMask & 2) != 0)) {
HXLINE( 991)				switch((int)(((this->s >> 2) & 3))){
            					case (int)0: {
HXLINE( 994)						swizzle = (swizzle + HX_("x",78,00,00,00));
            					}
            					break;
...
HXLINE( 989)			if (((this->sourceMask & 4) != 0)) {
HXLINE( 991)				switch((int)(((this->s >> 4) & 3))){
            					case (int)0: {
HXLINE( 994)						swizzle = (swizzle + HX_("x",78,00,00,00));
            					}
            					break;
...
HXLINE( 989)			if (((this->sourceMask & 8) != 0)) {
HXLINE( 991)				switch((int)(((this->s >> 6) & 3))){
            					case (int)0: {
HXLINE( 994)						swizzle = (swizzle + HX_("x",78,00,00,00));
            					}
            					break;
...
HXLINE(1006)		::String str = ::openfl::_internal::formats::agal::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXLINE(1008)		if ((this->d == 0)) {
HXLINE(1011)			str = (str + (this->n + offset));
            		}
            		else {
HXLINE(1016)			str = (str + this->o);
HXLINE(1017)			::String indexComponent = HX_("",00,00,00,00);
HXLINE(1018)			switch((int)(this->q)){
            				case (int)0: {
HXLINE(1021)					indexComponent = HX_("x",78,00,00,00);
            				}
            				break;
            				case (int)1: {
HXLINE(1023)					indexComponent = HX_("y",79,00,00,00);
            				}
            				break;
            				case (int)2: {
HXLINE(1025)					indexComponent = HX_("z",7a,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(1027)					indexComponent = HX_("w",77,00,00,00);
            				}
            				break;
            			}
HXLINE(1029)			::String indexRegister = ::openfl::_internal::formats::agal::AGALConverter_obj::prefixFromType(this->itype,this->programType);
HXDLIN(1029)			::String indexRegister1 = (((indexRegister + this->n) + HX_(".",2e,00,00,00)) + indexComponent);
HXLINE(1030)			str = (str + ((((HX_("[ int(",3e,aa,07,15) + indexRegister1) + HX_(") +",74,38,1f,00)) + offset) + HX_("]",5d,00,00,00)));
            		}
HXLINE(1033)		bool _hx_tmp1;
HXDLIN(1033)		if (emitSwizzle) {
HXLINE(1033)			_hx_tmp1 = (swizzle != HX_("",00,00,00,00));
            		}
            		else {
HXLINE(1033)			_hx_tmp1 = false;
            		}
HXDLIN(1033)		if (_hx_tmp1) {
HXLINE(1035)			str = (str + (HX_(".",2e,00,00,00) + swizzle));
            		}
HXLINE(1038)		return str;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(SourceRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister SourceRegister_obj::parse( cpp::Int64Struct v, ::openfl::_internal::formats::agal::_AGALConverter::ProgramType programType,int sourceMask){
            	HX_GC_STACKFRAME(&_hx_pos_c312f67fa56a379a_960_parse)
HXLINE( 961)		 ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister sr =  ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister_obj::__alloc( HX_CTX );
HXLINE( 962)		sr->programType = programType;
HXLINE( 963)		 cpp::Int64Struct a = _hx_int64_shr(v,63);
HXDLIN( 963)		sr->d = _hx_int64_low(_hx_int64_and(a,( ::cpp::Int64Struct(1))));
HXLINE( 964)		 cpp::Int64Struct a1 = _hx_int64_shr(v,48);
HXDLIN( 964)		sr->q = _hx_int64_low(_hx_int64_and(a1,( ::cpp::Int64Struct(3))));
HXLINE( 965)		 cpp::Int64Struct a2 = _hx_int64_shr(v,40);
HXDLIN( 965)		sr->itype = _hx_int64_low(_hx_int64_and(a2,( ::cpp::Int64Struct(15))));
HXLINE( 966)		 cpp::Int64Struct a3 = _hx_int64_shr(v,32);
HXDLIN( 966)		sr->type = _hx_int64_low(_hx_int64_and(a3,( ::cpp::Int64Struct(15))));
HXLINE( 967)		 cpp::Int64Struct a4 = _hx_int64_shr(v,24);
HXDLIN( 967)		sr->s = _hx_int64_low(_hx_int64_and(a4,( ::cpp::Int64Struct(255))));
HXLINE( 968)		 cpp::Int64Struct a5 = _hx_int64_shr(v,16);
HXDLIN( 968)		sr->o = _hx_int64_low(_hx_int64_and(a5,( ::cpp::Int64Struct(255))));
HXLINE( 969)		sr->n = _hx_int64_low(_hx_int64_and(v,( ::cpp::Int64Struct(65535))));
HXLINE( 970)		sr->sourceMask = sourceMask;
HXLINE( 971)		return sr;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_c312f67fa56a379a_945_boot)
HXDLIN( 945)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
