...
HX_DEFINE_STACK_FRAME(_hx_pos_2c9b0c284e068689_537_new,"openfl._internal.formats.agal._AGALConverter.DestRegister","new",0x710dba3a,"openfl._internal.formats.agal._AGALConverter.DestRegister.new","openfl/_internal/formats/agal/AGALConverter.hx",537,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_2c9b0c284e068689_540_getWriteMask,"openfl._internal.formats.agal._AGALConverter.DestRegister","getWriteMask",0x170bdcdb,"openfl._internal.formats.agal._AGALConverter.DestRegister.getWriteMask","openfl/_internal/formats/agal/AGALConverter.hx",540,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_2c9b0c284e068689_560_toGLSL,"openfl._internal.formats.agal._AGALConverter.DestRegister","toGLSL",0x15be935f,"openfl._internal.formats.agal._AGALConverter.DestRegister.toGLSL","openfl/_internal/formats/agal/AGALConverter.hx",560,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_2c9b0c284e068689_550_parse,"openfl._internal.formats.agal._AGALConverter.DestRegister","parse",0x3fc1248d,"openfl._internal.formats.agal._AGALConverter.DestRegister.parse","openfl/_internal/formats/agal/AGALConverter.hx",550,0x323dd368)
HX_LOCAL_STACK_FRAME(_hx_pos_2c9b0c284e068689_530_boot,"openfl._internal.formats.agal._AGALConverter.DestRegister","boot",0x730e3918,"openfl._internal.formats.agal._AGALConverter.DestRegister.boot","openfl/_internal/formats/agal/AGALConverter.hx",530,0x323dd368)
namespace openfl{
namespace _internal{
namespace formats{
namespace agal{
...
void DestRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_2c9b0c284e068689_537_new)
            	}
...
::String DestRegister_obj::getWriteMask(){
            	HX_STACKFRAME(&_hx_pos_2c9b0c284e068689_540_getWriteMask)
HXLINE( 541)		::String str = HX_(".",2e,00,00,00);
HXLINE( 542)		if (((this->mask & 1) != 0)) {
HXLINE( 542)			str = (str + HX_("x",78,00,00,00));
            		}
HXLINE( 543)		if (((this->mask & 2) != 0)) {
HXLINE( 543)			str = (str + HX_("y",79,00,00,00));
            		}
HXLINE( 544)		if (((this->mask & 4) != 0)) {
HXLINE( 544)			str = (str + HX_("z",7a,00,00,00));
            		}
HXLINE( 545)		if (((this->mask & 8) != 0)) {
HXLINE( 545)			str = (str + HX_("w",77,00,00,00));
            		}
HXLINE( 546)		return str;
            	}
...
::String DestRegister_obj::toGLSL(::hx::Null< bool >  __o_useMask){
            	...
            	HX_STACKFRAME(&_hx_pos_2c9b0c284e068689_560_toGLSL)
HXLINE( 561)		::String str;
HXLINE( 563)		if ((this->type == 3)) {
HXLINE( 565)			if (::hx::IsEq( this->programType,::openfl::_internal::formats::agal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
HXLINE( 565)				str = HX_("gl_Position",63,0d,2a,e5);
            			}
            			else {
HXLINE( 565)				str = HX_("gl_FragColor",d7,68,e4,21);
            			}
            		}
            		else {
HXLINE( 569)			::String str1 = ::openfl::_internal::formats::agal::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXDLIN( 569)			str = (str1 + this->n);
            		}
HXLINE( 572)		bool _hx_tmp;
HXDLIN( 572)		if (useMask) {
HXLINE( 572)			_hx_tmp = (this->mask != 15);
            		}
            		else {
HXLINE( 572)			_hx_tmp = false;
            		}
HXDLIN( 572)		if (_hx_tmp) {
HXLINE( 574)			str = (str + this->getWriteMask());
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(DestRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::formats::agal::_AGALConverter::DestRegister DestRegister_obj::parse(int v, ::openfl::_internal::formats::agal::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_2c9b0c284e068689_550_parse)
HXLINE( 551)		 ::openfl::_internal::formats::agal::_AGALConverter::DestRegister dr =  ::openfl::_internal::formats::agal::_AGALConverter::DestRegister_obj::__alloc( HX_CTX );
HXLINE( 552)		dr->programType = programType;
HXLINE( 553)		dr->type = (::hx::UShr(v,24) & 15);
HXLINE( 554)		dr->mask = (::hx::UShr(v,16) & 15);
HXLINE( 555)		dr->n = (v & 65535);
HXLINE( 556)		return dr;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_2c9b0c284e068689_530_boot)
HXDLIN( 530)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
