...
HXLINE( 895)				filter = 4;
            			...
            			break;
            			default:{
HXLINE( 897)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null())));
            			}
            		}
...
HXLINE( 911)				mipfilter = 0;
            			...
            			break;
            			default:{
HXLINE( 913)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null())));
            			}
            		}
...
HXLINE( 924)				wrap = 2;
            			...
            			break;
            			default:{
HXLINE( 926)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null())));
            			}
            		}
