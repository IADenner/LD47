...
HXLINE( 493)					glsl->b->push(HX_("precision highp float;\n",57,4a,f7,14));
            				}
            			}
            		}
            		else {
...
HXLINE( 497)				glsl->b = ::Array_obj< ::String >::fromData( _hx_array_data_75e363b4_12,1);
            			}
            			else {
HXLINE( 497)				glsl->b->push(HX_("#version 120\n",a6,a9,06,19));
            			}
            		}
HXLINE( 500)		{
HXLINE( 500)			::String x2 = map->toGLSL(false);
HXDLIN( 500)			if (::hx::IsNotNull( glsl->charBuf )) {
HXLINE( 500)				glsl->flush();
            			}
HXDLIN( 500)			if (::hx::IsNull( glsl->b )) {
HXLINE( 500)				glsl->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2));
            			}
            			else {
HXLINE( 500)				::Array< ::String > glsl1 = glsl->b;
HXDLIN( 500)				glsl1->push(::Std_obj::string(x2));
            			}
            		}
HXLINE( 502)		if (::hx::IsEq( programType,::openfl::_internal::formats::agal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
HXLINE( 505)			if (::hx::IsNotNull( glsl->charBuf )) {
HXLINE( 505)				glsl->flush();
            			}
HXDLIN( 505)			if (::hx::IsNull( glsl->b )) {
HXLINE( 505)				glsl->b = ::Array_obj< ::String >::fromData( _hx_array_data_75e363b4_13,1);
            			}
            			else {
HXLINE( 505)				glsl->b->push(HX_("uniform vec4 vcPositionScale;\n",cf,aa,4f,18));
            			}
            		}
HXLINE( 508)		{
...
HXLINE( 508)				glsl->b = ::Array_obj< ::String >::fromData( _hx_array_data_75e363b4_14,1);
            			}
            			else {
HXLINE( 508)				glsl->b->push(HX_("void main() {\n",49,b0,bf,fb));
            			}
            		}
HXLINE( 509)		{
HXLINE( 509)			::String x3 = map->toGLSL(true);
HXDLIN( 509)			if (::hx::IsNotNull( glsl->charBuf )) {
HXLINE( 509)				glsl->flush();
            			}
HXDLIN( 509)			if (::hx::IsNull( glsl->b )) {
HXLINE( 509)				glsl->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3));
            			}
            			else {
HXLINE( 509)				::Array< ::String > glsl1 = glsl->b;
HXDLIN( 509)				glsl1->push(::Std_obj::string(x3));
            			}
            		}
HXLINE( 510)		{
HXLINE( 510)			::String x4 = sb->toString();
HXDLIN( 510)			if (::hx::IsNotNull( glsl->charBuf )) {
HXLINE( 510)				glsl->flush();
            			}
HXDLIN( 510)			if (::hx::IsNull( glsl->b )) {
HXLINE( 510)				glsl->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4));
            			}
            			else {
HXLINE( 510)				::Array< ::String > glsl1 = glsl->b;
HXDLIN( 510)				glsl1->push(::Std_obj::string(x4));
            			}
            		}
HXLINE( 512)		if (::hx::IsEq( programType,::openfl::_internal::formats::agal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
HXLINE( 515)			if (::hx::IsNotNull( glsl->charBuf )) {
HXLINE( 515)				glsl->flush();
            			}
HXDLIN( 515)			if (::hx::IsNull( glsl->b )) {
HXLINE( 515)				glsl->b = ::Array_obj< ::String >::fromData( _hx_array_data_75e363b4_15,1);
            			}
            			else {
HXLINE( 515)				glsl->b->push(HX_("\tgl_Position *= vcPositionScale;\n",7c,ad,85,8d));
            			}
            		}
HXLINE( 518)		{
HXLINE( 518)			if (::hx::IsNotNull( glsl->charBuf )) {
HXLINE( 518)				glsl->flush();
            			}
HXDLIN( 518)			if (::hx::IsNull( glsl->b )) {
HXLINE( 518)				glsl->b = ::Array_obj< ::String >::fromData( _hx_array_data_75e363b4_16,1);
            			}
            			else {
HXLINE( 518)				glsl->b->push(HX_("}\n",ed,6c,00,00));
            			}
            		}
HXLINE( 521)		return glsl->toString();
            	}
