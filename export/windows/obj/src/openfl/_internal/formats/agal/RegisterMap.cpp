...
HXLINE( 609)						HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,HX_("Cannot use register in multiple ways yet (mat4/vec4)",5e,30,e0,74))));
            					}
HXLINE( 612)					return;
            				}
            			}
            		}
HXLINE( 616)		 ::openfl::_internal::formats::agal::_AGALConverter::RegisterMapEntry entry =  ::openfl::_internal::formats::agal::_AGALConverter::RegisterMapEntry_obj::__alloc( HX_CTX );
HXLINE( 617)		entry->type = type;
HXLINE( 618)		entry->name = name;
HXLINE( 619)		entry->number = number;
HXLINE( 620)		entry->usage = usage;
HXLINE( 621)		this->mEntries->push(entry);
            	}
...
HXLINE( 643)		int sr1 = sr->type;
HXDLIN( 643)		::String _hx_tmp = sr->toGLSL(false,offset);
HXDLIN( 643)		this->add(sr1,_hx_tmp,(sr->n + offset),usage);
            	}
...
HXLINE( 680)			return (a->type - b->type);
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXLINE( 722)							sb->b->push(HX_("uniform ",6c,cc,54,02));
            					...
            					break;
            					default:{
HXLINE( 725)						HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null())));
            					}
            				}
...
HXDLIN( 763)							sb1->push(::Std_obj::string(x1));
            						}
            					}
HXLINE( 764)					{
...
HXDLIN( 768)							sb1->push(::Std_obj::string(x2));
            						}
            					}
HXLINE( 769)					{
...
HXLINE( 774)						{
HXLINE( 774)							::String x = entry->name;
HXDLIN( 774)							if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 774)								sb->flush();
            							}
HXDLIN( 774)							if (::hx::IsNull( sb->b )) {
HXLINE( 774)								sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x));
            							}
            							else {
HXLINE( 774)								::Array< ::String > sb1 = sb->b;
HXDLIN( 774)								sb1->push(::Std_obj::string(x));
            							}
            						}
HXLINE( 775)						{
...
HXLINE( 779)						{
HXLINE( 779)							::String x1 = (entry->name + HX_("_alpha",9f,ee,7d,1d));
HXDLIN( 779)							if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 779)								sb->flush();
            							}
HXDLIN( 779)							if (::hx::IsNull( sb->b )) {
HXLINE( 779)								sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            							}
            							else {
HXLINE( 779)								::Array< ::String > sb1 = sb->b;
HXDLIN( 779)								sb1->push(::Std_obj::string(x1));
            							}
            						}
HXLINE( 780)						{
...
HXLINE( 784)						{
HXLINE( 784)							::String x2 = (entry->name + HX_("_alphaEnabled",a2,df,12,f4));
HXDLIN( 784)							if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 784)								sb->flush();
            							}
HXDLIN( 784)							if (::hx::IsNull( sb->b )) {
HXLINE( 784)								sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2));
            							}
            							else {
HXLINE( 784)								::Array< ::String > sb1 = sb->b;
HXDLIN( 784)								sb1->push(::Std_obj::string(x2));
            							}
            						}
HXLINE( 785)						{
...
HXLINE( 789)							{
HXLINE( 789)								::String x = (entry->name + HX_("[128]",21,60,00,86));
HXDLIN( 789)								if (::hx::IsNotNull( sb->charBuf )) {
HXLINE( 789)									sb->flush();
            								}
HXDLIN( 789)								if (::hx::IsNull( sb->b )) {
HXLINE( 789)									sb->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x));
            								}
            								else {
HXLINE( 789)									::Array< ::String > sb1 = sb->b;
HXDLIN( 789)									sb1->push(::Std_obj::string(x));
            								}
            							}
HXLINE( 790)							{
...
HXLINE( 794)							{
HXLINE( 794)								::String x = entry->name;
