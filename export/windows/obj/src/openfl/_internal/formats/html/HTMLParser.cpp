...
HXLINE( 109)							 ::openfl::_internal::text::TextFormatRange _hx_tmp = textFormatRanges->get((textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::_internal::text::TextFormatRange >();
HXDLIN( 109)							_hx_tmp->end++;
            						}
HXLINE( 112)						if ((start < segment.length)) {
HXLINE( 114)							sub = segment.substr(start,null());
...
HXLINE( 129)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexHref->match(segment)) {
...
HXLINE( 147)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexFace->match(segment)) {
...
HXLINE( 152)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexColor->match(segment)) {
...
HXLINE( 157)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexSize->match(segment)) {
...
HXLINE( 162)										_hx_tmp = ::hx::IsEq( firstChar,45 );
            									}
            									else {
...
HXLINE( 135)									_hx_tmp = !(noLineBreak);
            								}
            								else {
...
HXLINE( 140)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexAlign->match(segment)) {
...
HXLINE( 183)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexBlockIndent->match(segment)) {
...
HXLINE( 188)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexIndent->match(segment)) {
...
HXLINE( 193)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexLeading->match(segment)) {
...
HXLINE( 198)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexLeftMargin->match(segment)) {
...
HXLINE( 203)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexRightMargin->match(segment)) {
...
HXLINE( 208)								if (::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexTabStops->match(segment)) {
...
HXLINE( 213)									{
HXLINE( 213)										int _g = 0;
HXDLIN( 213)										while((_g < values->length)){
HXLINE( 213)											::String stop = values->__get(_g);
HXDLIN( 213)											_g = (_g + 1);
...
HXLINE( 225)							if ((start < segment.length)) {
HXLINE( 227)								sub = segment.substring(start,null());
...
HXLINE( 232)								if ((textFormatRanges->get_length() > 0)) {
HXLINE( 234)									 ::openfl::_internal::text::TextFormatRange _hx_tmp = textFormatRanges->get((textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::_internal::text::TextFormatRange >();
HXDLIN( 234)									_hx_tmp->end++;
            								}
            							}
            						}
            						else {
HXLINE( 239)							textFormatRanges->push( ::openfl::_internal::text::TextFormatRange_obj::__alloc( HX_CTX ,format,value.length,(value.length + segment.length)));
HXLINE( 240)							value = (value + segment);
HXLINE( 241)							noLineBreak = false;
            						}
            					}
            				}
            			}
HXLINE( 246)			if ((textFormatRanges->get_length() == 0)) {
HXLINE( 248)				textFormatRanges->push( ::openfl::_internal::text::TextFormatRange_obj::__alloc( HX_CTX ,formatStack->__get(0).StaticCast<  ::openfl::text::TextFormat >(),0,0));
            			}
            		}
...
HXDLIN( 257)		if (::hx::IsNotNull( regex->matched(2) )) {
HXDLIN( 257)			return regex->matched(2);
            		}
            		else {
HXDLIN( 257)			return regex->matched(3);
            		}
