...
HX_DEFINE_STACK_FRAME(_hx_pos_281fad3e86f1efa8_585_new,"lime.utils._Assets.LibrarySymbol","new",0x85584603,"lime.utils._Assets.LibrarySymbol.new","lime/utils/Assets.hx",585,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_281fad3e86f1efa8_593_isLocal,"lime.utils._Assets.LibrarySymbol","isLocal",0x28a9f044,"lime.utils._Assets.LibrarySymbol.isLocal","lime/utils/Assets.hx",593,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_281fad3e86f1efa8_596_exists,"lime.utils._Assets.LibrarySymbol","exists",0xf7109019,"lime.utils._Assets.LibrarySymbol.exists","lime/utils/Assets.hx",596,0x95055f23)
namespace lime{
namespace utils{
namespace _Assets{

void LibrarySymbol_obj::__construct(::String id){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_585_new)
HXLINE( 586)		int colonIndex = id.indexOf(HX_(":",3a,00,00,00),null());
HXLINE( 587)		this->libraryName = id.substring(0,colonIndex);
HXLINE( 588)		this->symbolName = id.substring((colonIndex + 1),null());
HXLINE( 589)		this->library = ::lime::utils::Assets_obj::getLibrary(this->libraryName);
            	}
...
bool LibrarySymbol_obj::isLocal(::String type){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_593_isLocal)
HXDLIN( 593)		return this->library->isLocal(this->symbolName,type);
            	}
...
bool LibrarySymbol_obj::exists(::String type){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_596_exists)
HXDLIN( 596)		return this->library->exists(this->symbolName,type);
            	}
