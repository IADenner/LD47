...
HXLINE( 108)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Not sure how to get template: ",a1,19,8c,ad) + id)));
...
HXLINE( 125)						_hx_tmp = ::lime::utils::Assets_obj::cache->enabled;
            					}
            					else {
...
HXLINE( 144)			::String _hx_tmp = ::lime::utils::Assets_obj::_hx___libraryNotFound(symbol_libraryName);
HXDLIN( 144)			::lime::utils::Log_obj::error(_hx_tmp,::hx::SourceInfo(HX_("lime/utils/Assets.hx",23,5f,05,95),144,HX_("lime.utils.Assets",39,6e,7e,b0),HX_("getAsset",7a,79,10,86)));
            		}
...
HXLINE( 331)				goto _hx_goto_16;
            			...
            			if (  (_hx_switch_0==HX_("TEMPLATE",3a,78,cd,05)) ){
HXLINE( 340)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Not sure how to get template: ",a1,19,8c,ad) + id)));
...
HXLINE( 355)					_hx_tmp = ::lime::utils::Assets_obj::cache->enabled;
            				}
            				else {
...
HXLINE( 421)				 ::lime::utils::AssetLibrary library = ::lime::utils::AssetLibrary_obj::fromBundle(bundle);
HXLINE( 423)				if (::hx::IsNull( library )) {
HXLINE( 425)					promise->error(((HX_("Cannot open library \"",44,cc,55,e7) + id) + HX_("\"",22,00,00,00)));
            				}
            				else {
HXLINE( 429)					::lime::utils::Assets_obj::libraries->set(id,library);
HXLINE( 430)					library->onChange->add(::lime::utils::Assets_obj::onChange->dispatch_dyn(),null(),null());
HXLINE( 431)					 ::lime::app::Promise_lime_utils_AssetLibrary promise1 = promise;
HXDLIN( 431)					promise1->completeWith(library->load());
            				}
            			}
            			HX_END_LOCAL_FUNC1((void))
...
HXLINE( 465)				 ::lime::utils::AssetLibrary library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE( 467)				if (::hx::IsNull( library )) {
HXLINE( 469)					promise->error(((HX_("Cannot open library \"",44,cc,55,e7) + id) + HX_("\"",22,00,00,00)));
            				}
            				else {
HXLINE( 473)					::lime::utils::Assets_obj::libraries->set(id,library);
HXLINE( 474)					library->onChange->add(::lime::utils::Assets_obj::onChange->dispatch_dyn(),null(),null());
HXLINE( 475)					 ::lime::app::Promise_lime_utils_AssetLibrary promise1 = promise;
HXDLIN( 475)					promise1->completeWith(library->load());
            				}
            			}
            			HX_END_LOCAL_FUNC1((void))
...
HXLINE( 453)				::String rootPath1;
HXDLIN( 453)				if ((::lime::utils::Assets_obj::defaultRootPath != HX_("",00,00,00,00))) {
HXLINE( 453)					rootPath1 = (::lime::utils::Assets_obj::defaultRootPath + HX_("/",2f,00,00,00));
            				}
            				else {
HXLINE( 453)					rootPath1 = HX_("",00,00,00,00);
            				}
HXDLIN( 453)				rootPath = (rootPath1 + ::haxe::io::Path_obj::directory(path));
