...
HXDLIN( 787)						goto _hx_goto_11;
            					...
            					if (  (_hx_switch_0==2) ){
HXLINE( 789)						int this1 = 0;
HXDLIN( 789)						int bgra = this1;
...
HXDLIN( 829)						goto _hx_goto_13;
            					...
            					if (  (_hx_switch_0==2) ){
HXLINE( 831)						int this1 = 0;
HXDLIN( 831)						int bgra = this1;
...
HXLINE(1098)				 ::Dynamic _hx_tmp =  ::Dynamic(this->buffer->_hx___srcBitmapData->__Field(HX_("merge",b8,a2,c6,05),::hx::paccDynamic));
HXDLIN(1098)				 ::Dynamic sourceImage1 = sourceImage->buffer->_hx___srcBitmapData;
HXDLIN(1098)				 ::Dynamic _hx_tmp1 = sourceRect->_hx___toFlashRectangle();
HXDLIN(1098)				_hx_tmp(sourceImage1,_hx_tmp1,destPoint->_hx___toFlashPoint(),redMultiplier,greenMultiplier,blueMultiplier,alphaMultiplier);
            			}
            			break;
            			default:{
HXLINE(1102)				return;
...
HXDLIN(1198)						int this1 = 0;
HXDLIN(1198)						int argb1 = this1;
HXDLIN(1198)						argb1 = ((((((bgra & 255) & 255) << 24) | (((::hx::UShr(bgra,8) & 255) & 255) << 16)) | (((::hx::UShr(bgra,16) & 255) & 255) << 8)) | ((::hx::UShr(bgra,24) & 255) & 255));
HXLINE(1195)						argb = argb1;
...
HXDLIN(1235)						int this1 = 0;
HXDLIN(1235)						int argb1 = this1;
HXDLIN(1235)						argb1 = ((((((bgra & 255) & 255) << 24) | (((::hx::UShr(bgra,8) & 255) & 255) << 16)) | (((::hx::UShr(bgra,16) & 255) & 255) << 8)) | ((::hx::UShr(bgra,24) & 255) & 255));
HXLINE(1232)						argb = argb1;
...
HXDLIN(1377)						argb = ((((((bgra & 255) & 255) << 24) | (((::hx::UShr(bgra,8) & 255) & 255) << 16)) | (((::hx::UShr(bgra,16) & 255) & 255) << 8)) | ((::hx::UShr(bgra,24) & 255) & 255));
HXLINE(1374)						_color = argb;
...
HXLINE(1385)					int rgba = mask;
HXDLIN(1385)					int this1 = 0;
HXDLIN(1385)					int argb = this1;
HXDLIN(1385)					argb = ((((((rgba & 255) & 255) << 24) | (((::hx::UShr(rgba,24) & 255) & 255) << 16)) | (((::hx::UShr(rgba,16) & 255) & 255) << 8)) | ((::hx::UShr(rgba,8) & 255) & 255));
HXLINE(1381)					_mask = argb;
            				}
            				else {
...
HXDLIN(1381)						goto _hx_goto_25;
            					...
            					if (  (_hx_switch_1==2) ){
HXLINE(1384)						int bgra = mask;
HXDLIN(1384)						int this1 = 0;
HXDLIN(1384)						int argb = this1;
HXDLIN(1384)						argb = ((((((bgra & 255) & 255) << 24) | (((::hx::UShr(bgra,8) & 255) & 255) << 16)) | (((::hx::UShr(bgra,16) & 255) & 255) << 8)) | ((::hx::UShr(bgra,24) & 255) & 255));
HXLINE(1381)						_mask = argb;
...
HXLINE(1391)				 ::Dynamic _hx_tmp =  ::Dynamic(this->buffer->_hx___srcBitmapData->__Field(HX_("threshold",ab,c3,a3,34),::hx::paccDynamic));
HXDLIN(1391)				 ::Dynamic _hx_tmp1 = sourceImage->buffer->get_src();
HXDLIN(1391)				 ::Dynamic _hx_tmp2 = sourceRect->_hx___toFlashRectangle();
HXDLIN(1391)				return ( (int)(_hx_tmp(_hx_tmp1,_hx_tmp2,destPoint->_hx___toFlashPoint(),operation,threshold,_color,_mask,copySource)) );
            			}
            			break;
            			default:{
            			}
...
HXDLIN(1414)			r1->height = (r1->height - -(r->y));
...
HXLINE(1422)			 ::lime::math::Rectangle r1 = r;
HXDLIN(1422)			r1->width = (r1->width - ((r->x + r->width) - ( (Float)(this->width) )));
HXLINE(1424)			if ((r->width <= 0)) {
HXLINE(1424)				return null();
            			}
            		}
HXLINE(1427)		if (((r->y + r->height) >= this->height)) {
HXLINE(1429)			 ::lime::math::Rectangle r1 = r;
HXDLIN(1429)			r1->height = (r1->height - ((r->y + r->height) - ( (Float)(this->height) )));
...
HXLINE(1501)					 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1501)					::cpp::VirtualArray array = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(1501)					_this->byteOffset = 0;
HXDLIN(1501)					_this->length = array->get_length();
HXDLIN(1501)					_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN(1501)					 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
...
HXDLIN(1501)						int elementSize = _this->bytesPerElement;
HXDLIN(1501)						if ((view->type == _this->type)) {
HXLINE(1501)							int srcLength = srcData->length;
HXDLIN(1501)							int cloneLength = (srcLength - srcByteOffset);
HXDLIN(1501)							 ::haxe::io::Bytes this1 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1501)							_this->buffer = this1;
HXDLIN(1501)							_this->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE(1501)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("unimplemented",09,2f,74,b4)));
            						}
HXDLIN(1501)						_this->byteLength = (_this->bytesPerElement * srcLength);
HXDLIN(1501)						_this->byteOffset = 0;
HXDLIN(1501)						_this->length = srcLength;
HXDLIN(1501)						this1 = _this;
            					}
            					else {
...
HXLINE(1501)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            							}
HXDLIN(1501)							if ((::hx::Mod(in_byteOffset,_this->bytesPerElement) != 0)) {
HXLINE(1501)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            							}
...
HXDLIN(1501)								if ((::hx::Mod(bufferByteLength,_this->bytesPerElement) != 0)) {
HXLINE(1501)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
...
HXLINE(1501)								newByteLength = (( (int)(len) ) * _this->bytesPerElement);
HXDLIN(1501)								int newRange = (in_byteOffset + newByteLength);
HXDLIN(1501)								if ((newRange > bufferByteLength)) {
HXLINE(1501)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
            							}
HXDLIN(1501)							_this->buffer = buffer;
HXDLIN(1501)							_this->byteOffset = in_byteOffset;
HXDLIN(1501)							_this->byteLength = newByteLength;
HXDLIN(1501)							_this->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this->bytesPerElement) )));
HXDLIN(1501)							this1 = _this;
            						}
            						else {
HXLINE(1501)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85)));
            						}
            					}
            				}
            			}
...
HXLINE(1627)						 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1627)						::cpp::VirtualArray array = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(1627)						_this->byteOffset = 0;
HXDLIN(1627)						_this->length = array->get_length();
HXDLIN(1627)						_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN(1627)						 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
...
HXDLIN(1627)							int elementSize = _this->bytesPerElement;
HXDLIN(1627)							if ((view->type == _this->type)) {
HXLINE(1627)								int srcLength = srcData->length;
HXDLIN(1627)								int cloneLength = (srcLength - srcByteOffset);
HXDLIN(1627)								 ::haxe::io::Bytes this1 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1627)								_this->buffer = this1;
HXDLIN(1627)								_this->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE(1627)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("unimplemented",09,2f,74,b4)));
            							}
HXDLIN(1627)							_this->byteLength = (_this->bytesPerElement * srcLength);
HXDLIN(1627)							_this->byteOffset = 0;
HXDLIN(1627)							_this->length = srcLength;
HXDLIN(1627)							this1 = _this;
            						}
            						else {
...
HXLINE(1627)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
HXDLIN(1627)								if ((::hx::Mod(in_byteOffset,_this->bytesPerElement) != 0)) {
HXLINE(1627)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
...
HXDLIN(1627)									if ((::hx::Mod(bufferByteLength,_this->bytesPerElement) != 0)) {
HXLINE(1627)										HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            									}
...
HXLINE(1627)									newByteLength = (( (int)(len) ) * _this->bytesPerElement);
HXDLIN(1627)									int newRange = (in_byteOffset + newByteLength);
HXDLIN(1627)									if ((newRange > bufferByteLength)) {
HXLINE(1627)										HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            									}
            								}
HXDLIN(1627)								_this->buffer = buffer1;
HXDLIN(1627)								_this->byteOffset = in_byteOffset;
HXDLIN(1627)								_this->byteLength = newByteLength;
HXDLIN(1627)								_this->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this->bytesPerElement) )));
HXDLIN(1627)								this1 = _this;
            							}
            							else {
HXLINE(1627)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85)));
            							}
            						}
            					}
            				}
...
HXLINE(1863)				_hx_tmp = this->buffer->premultiplied;
            			}
            			else {
