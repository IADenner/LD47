...
HXLINE(1709)			 ::lime::math::Rectangle _hx_tmp = this->rect;
HXDLIN(1709)			_hx_tmp->x = (_hx_tmp->x + x);
HXLINE(1710)			 ::lime::math::Rectangle _hx_tmp1 = this->rect;
HXDLIN(1710)			_hx_tmp1->width = (_hx_tmp1->width - ( (Float)(x) ));
            		}
HXLINE(1713)		if ((y < 0)) {
HXLINE(1715)			 ::lime::math::Rectangle _hx_tmp = this->rect;
HXDLIN(1715)			_hx_tmp->y = (_hx_tmp->y + y);
HXLINE(1716)			if ((this->rect->y < 0)) {
HXLINE(1716)				this->rect->y = ( (Float)(0) );
            			}
            		}
            		else {
HXLINE(1720)			 ::lime::math::Rectangle _hx_tmp = this->rect;
HXDLIN(1720)			_hx_tmp->y = (_hx_tmp->y + y);
HXLINE(1721)			 ::lime::math::Rectangle _hx_tmp1 = this->rect;
HXDLIN(1721)			_hx_tmp1->height = (_hx_tmp1->height - ( (Float)(y) ));
            		}
