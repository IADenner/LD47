...
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_393_curl_onWrite,"lime._internal.backend.native.NativeHTTPRequest","curl_onWrite",0x97fe6bfd,"lime._internal.backend.native.NativeHTTPRequest.curl_onWrite","lime/_internal/backend/native/NativeHTTPRequest.hx",393,0xfe6a4b7e)
...
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_533_multiThreadPool_onComplete,"lime._internal.backend.native.NativeHTTPRequest","multiThreadPool_onComplete",0xd0260028,"lime._internal.backend.native.NativeHTTPRequest.multiThreadPool_onComplete","lime/_internal/backend/native/NativeHTTPRequest.hx",533,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_556_multiThreadPool_onProgress,"lime._internal.backend.native.NativeHTTPRequest","multiThreadPool_onProgress",0xd688f71c,"lime._internal.backend.native.NativeHTTPRequest.multiThreadPool_onProgress","lime/_internal/backend/native/NativeHTTPRequest.hx",556,0xfe6a4b7e)
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_603_multiProgressTimer_onRun,"lime._internal.backend.native.NativeHTTPRequest","multiProgressTimer_onRun",0x7d995edc,"lime._internal.backend.native.NativeHTTPRequest.multiProgressTimer_onRun","lime/_internal/backend/native/NativeHTTPRequest.hx",603,0xfe6a4b7e)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
int NativeHTTPRequest_obj::curl_onWrite( ::lime::net::curl::CURL curl, ::haxe::io::Bytes output){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_393_curl_onWrite)
HXLINE( 394)		this->growBuffer((this->writePosition + output->length));
HXLINE( 395)		this->bytes->blit(this->writePosition,output,0,output->length);
HXLINE( 397)		 ::lime::_internal::backend::native::NativeHTTPRequest _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 397)		_hx_tmp->writePosition = (_hx_tmp->writePosition + output->length);
...
HXLINE( 522)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->removeHandle(curl);
HXLINE( 523)					curl->cleanup();
HXLINE( 525)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multiThreadPool->sendProgress( ::Dynamic(::hx::Anon_obj::Create(3)
...
HXLINE( 526)					message = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->infoRead();
            				}
            			}
            		}
            		_hx_goto_18:;
...
void NativeHTTPRequest_obj::multiThreadPool_onComplete( ::Dynamic _){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_533_multiThreadPool_onComplete)
HXLINE( 535)		 ::lime::net::curl::CURL curl = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multiAddHandle->pop(false).StaticCast<  ::lime::net::curl::CURL >();
HXLINE( 537)		if (::hx::IsNotNull( curl )) {
HXLINE( 539)			::lime::_internal::backend::native::NativeHTTPRequest_obj::multiAddHandle->push(curl);
HXLINE( 540)			::lime::_internal::backend::native::NativeHTTPRequest_obj::multiThreadPool->queue(null());
            		}
            		else {
HXLINE( 544)			if (::hx::IsNotNull( ::lime::_internal::backend::native::NativeHTTPRequest_obj::multiProgressTimer )) {
HXLINE( 546)				::lime::_internal::backend::native::NativeHTTPRequest_obj::multiProgressTimer->stop();
HXLINE( 547)				::lime::_internal::backend::native::NativeHTTPRequest_obj::multiProgressTimer = null();
            			}
HXLINE( 550)			::lime::_internal::backend::native::NativeHTTPRequest_obj::multiThreadPoolRunning = false;
            		}
            	}
...
void NativeHTTPRequest_obj::multiThreadPool_onProgress( ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_556_multiThreadPool_onProgress)
HXLINE( 557)		if (::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->exists( ::Dynamic(state->__Field(HX_("curl",ec,4a,c9,41),::hx::paccDynamic)))) {
HXLINE( 559)			 ::lime::_internal::backend::native::NativeHTTPRequest instance = ( ( ::lime::_internal::backend::native::NativeHTTPRequest)(::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->get( ::Dynamic(state->__Field(HX_("curl",ec,4a,c9,41),::hx::paccDynamic)))) );
HXLINE( 560)			::lime::_internal::backend::native::NativeHTTPRequest_obj::activeInstances->remove(instance);
HXLINE( 561)			::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->remove( ::Dynamic(state->__Field(HX_("curl",ec,4a,c9,41),::hx::paccDynamic)));
HXLINE( 563)			instance->parent->__SetField(HX_("responseStatus",93,60,a4,78),state->__Field(HX_("status",32,e7,fb,05),::hx::paccDynamic),::hx::paccDynamic);
HXLINE( 565)			if (::hx::IsEq( state->__Field(HX_("result",dd,68,84,08),::hx::paccDynamic),0 )) {
HXLINE( 567)				bool _hx_tmp;
HXDLIN( 567)				bool _hx_tmp1;
HXDLIN( 567)				if (::hx::IsGreaterEq( state->__Field(HX_("status",32,e7,fb,05),::hx::paccDynamic),200 )) {
HXLINE( 567)					_hx_tmp1 = ::hx::IsLess( state->__Field(HX_("status",32,e7,fb,05),::hx::paccDynamic),400 );
            				}
            				else {
HXLINE( 567)					_hx_tmp1 = false;
            				}
HXDLIN( 567)				if (!(_hx_tmp1)) {
HXLINE( 567)					_hx_tmp = ::hx::IsEq( state->__Field(HX_("status",32,e7,fb,05),::hx::paccDynamic),0 );
            				}
            				else {
HXLINE( 567)					_hx_tmp = true;
            				}
HXDLIN( 567)				if (_hx_tmp) {
HXLINE( 569)					if (!(instance->promise->get_isError())) {
HXLINE( 571)						instance->promise->complete(instance->bytes);
            					}
            				}
            				else {
HXLINE( 574)					if (::hx::IsNotNull( instance->bytes )) {
HXLINE( 576)						 ::lime::app::Promise_haxe_io_Bytes instance1 = instance->promise;
HXDLIN( 576)						instance1->error(instance->bytes->getString(0,instance->bytes->length,null()));
            					}
            					else {
HXLINE( 580)						instance->promise->error( ::Dynamic((HX_("Status ",8e,8c,bf,03) + state->__Field(HX_("status",32,e7,fb,05),::hx::paccDynamic))));
            					}
            				}
            			}
            			else {
HXLINE( 585)				 ::lime::app::Promise_haxe_io_Bytes instance1 = instance->promise;
HXDLIN( 585)				instance1->error(::lime::net::curl::CURL_obj::strerror(( (int)(state->__Field(HX_("result",dd,68,84,08),::hx::paccDynamic)) )));
            			}
HXLINE( 588)			if (::hx::IsNotNull( instance->timeout )) {
HXLINE( 590)				instance->timeout->stop();
HXLINE( 591)				instance->timeout = null();
            			}
HXLINE( 594)			instance->bytes = null();
HXLINE( 595)			instance->promise = null();
            		}
HXLINE( 598)		state->__SetField(HX_("curl",ec,4a,c9,41),null(),::hx::paccDynamic);
            	}
...
void NativeHTTPRequest_obj::multiProgressTimer_onRun(){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_603_multiProgressTimer_onRun)
HXDLIN( 603)		int _g = 0;
HXDLIN( 603)		::Array< ::Dynamic> _g1 = ::lime::_internal::backend::native::NativeHTTPRequest_obj::activeInstances;
HXDLIN( 603)		while((_g < _g1->length)){
HXDLIN( 603)			 ::lime::_internal::backend::native::NativeHTTPRequest instance = _g1->__get(_g).StaticCast<  ::lime::_internal::backend::native::NativeHTTPRequest >();
HXDLIN( 603)			_g = (_g + 1);
HXLINE( 605)			bool _hx_tmp;
HXDLIN( 605)			if ((instance->bytesLoaded == instance->writeBytesLoaded)) {
HXLINE( 605)				_hx_tmp = (instance->bytesTotal != instance->writeBytesTotal);
            			}
            			else {
HXLINE( 605)				_hx_tmp = true;
            			}
HXDLIN( 605)			if (_hx_tmp) {
HXLINE( 607)				instance->bytesLoaded = instance->writeBytesLoaded;
HXLINE( 608)				instance->bytesTotal = instance->writeBytesTotal;
HXLINE( 609)				instance->promise->progress(instance->bytesLoaded,instance->bytesTotal);
            			}
            		}
            	}
