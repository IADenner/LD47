...
HXLINE( 223)					_hx_tmp1 = !(this->isError);
            				}
            				else {
HXLINE( 223)					_hx_tmp1 = false;
            				}
HXDLIN( 223)				if (_hx_tmp1) {
HXLINE( 223)					_hx_tmp = (time <= end);
            				}
            				else {
...
HXLINE( 282)					 ::lime::app::Future future = ( ( ::lime::app::Future)(next(val)) );
HXLINE( 283)					future->onError(promise->error_dyn());
HXLINE( 284)					future->onComplete(promise->complete_dyn());
            				}
