...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("OraclesQuest",8d,17,14,92),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("ROOKMAGE",0b,35,9e,1f));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("OraclesQuest",8d,17,14,92));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("OraclesQuest",8d,17,14,92));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("OraclesQuest",8d,17,14,92))
...
HXLINE( 190)					_hx_tmp = !(::Std_obj::isOfType(current,( ( ::Dynamic)(::hx::ClassOf< ::openfl::display::DisplayObjectContainer >()) )));
            				}
            				else {
