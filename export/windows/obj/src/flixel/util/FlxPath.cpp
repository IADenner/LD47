...
HXDLIN( 793)				{
HXLINE( 793)					 ::flixel::math::FlxPoint _g = _this;
HXDLIN( 793)					_g->set_x((_g->x - Camera->viewOffsetX));
            				}
HXDLIN( 793)				{
HXLINE( 793)					 ::flixel::math::FlxPoint _g1 = _this;
HXDLIN( 793)					_g1->set_y((_g1->y - Y));
            				}
            			}
