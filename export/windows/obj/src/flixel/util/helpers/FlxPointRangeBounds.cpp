...
HXDLIN(  85)		if (result) {
HXLINE(  86)			 ::flixel::math::FlxPoint _this = ( ( ::flixel::math::FlxPoint)(this->start->max) );
HXDLIN(  86)			 ::flixel::math::FlxPoint point = ( ( ::flixel::math::FlxPoint)(OtherFlxPointRangeBounds->start->max) );
...
HXLINE(  87)			 ::flixel::math::FlxPoint _this = ( ( ::flixel::math::FlxPoint)(this->end->min) );
HXDLIN(  87)			 ::flixel::math::FlxPoint point = ( ( ::flixel::math::FlxPoint)(OtherFlxPointRangeBounds->end->min) );
...
HXLINE(  88)			 ::flixel::math::FlxPoint _this = ( ( ::flixel::math::FlxPoint)(this->end->max) );
HXDLIN(  88)			 ::flixel::math::FlxPoint point = ( ( ::flixel::math::FlxPoint)(OtherFlxPointRangeBounds->end->max) );
