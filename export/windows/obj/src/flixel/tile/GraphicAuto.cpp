...
HX_LOCAL_STACK_FRAME(_hx_pos_c1d34ebf00445d90_32_boot,"flixel.tile.GraphicAuto","boot",0x23888f97,"flixel.tile.GraphicAuto.boot","flixel/tile/FlxTilemap.hx",32,0x448feb74)
namespace flixel{
namespace tile{
...
{
{
            	HX_STACKFRAME(&_hx_pos_c1d34ebf00445d90_32_boot)
HXDLIN(  32)		resourceName = HX_("__ASSET__:bitmap_flixel_tile_GraphicAuto",23,e3,b5,f1);
            	}
}
