...
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_117_update,"flixel.FlxBasic","update",0x307e9d29,"flixel.FlxBasic.update","flixel/FlxBasic.hx",117,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_128_draw,"flixel.FlxBasic","draw",0x12af3b24,"flixel.FlxBasic.draw","flixel/FlxBasic.hx",128,0xd8d6cfcf)
...
void FlxBasic_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_117_update)
HXDLIN( 117)		::flixel::FlxBasic_obj::activeCount++;
            	}
...
void FlxBasic_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_128_draw)
HXDLIN( 128)		::flixel::FlxBasic_obj::visibleCount++;
            	}
