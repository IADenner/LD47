...
HXLINE( 448)		this->destroy();
HXLINE( 450)		{
HXLINE( 450)			 ::flixel::_hx_system::debug::FlxDebugger _this = ::flixel::FlxG_obj::game->debugger;
HXDLIN( 450)			if (_this->contains(::hx::ObjectPtr<OBJ_>(this))) {
HXLINE( 450)				_this->removeChild(::hx::ObjectPtr<OBJ_>(this));
            			}
HXDLIN( 450)			{
HXLINE( 450)				::Array< ::Dynamic> array = _this->_windows;
HXDLIN( 450)				int index = array->indexOf(::hx::ObjectPtr<OBJ_>(this),null());
HXDLIN( 450)				if ((index != -1)) {
HXLINE( 450)					array[index] = array->__get((array->length - 1)).StaticCast<  ::flixel::_hx_system::debug::Window >();
HXDLIN( 450)					array->pop().StaticCast<  ::flixel::_hx_system::debug::Window >();
            				}
            			}
            		}
            	}
