...
HXLINE(  86)		 ::flixel::_hx_system::debug::log::BitmapLog _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 351)		{
HXLINE( 351)			 ::flixel::_hx_system::debug::log::BitmapLog _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 351)			int _hx_tmp;
...
HXDLIN( 351)			_g->set_zoom((_g->zoom + ((( (Float)(_hx_tmp) ) * ((Float)0.25)) * this->zoom)));
            		}
