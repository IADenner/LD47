...
HXDLIN( 224)				_g = (_g + 1);
HXLINE( 225)				if (::hx::IsEq( profile->objectClass,ObjectClass )) {
...
HXDLIN(  68)				if (!(::Std_obj::isOfType(Object,( ( ::Dynamic)(profile->objectClass) )))) {
HXLINE(  68)					_hx_tmp = ::hx::IsEq( Object,profile->objectClass );
            				}
            				else {
...
HXLINE( 130)			{
HXLINE( 130)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile15 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::flixel::util::FlxPath >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_28,6),null());
...
HXLINE( 149)			{
HXLINE( 149)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile19 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::flixel::input::mouse::FlxMouse >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_32,14),::Array_obj< ::Dynamic>::__new(1)->init(0,::hx::ClassOf< ::flixel::math::FlxPoint >()));
...
HXLINE( 182)			{
HXLINE( 182)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile23 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::openfl::geom::Point >(),null(),::Array_obj< ::Dynamic>::__new(1)->init(0,::hx::ClassOf< ::flixel::math::FlxPoint >()));
