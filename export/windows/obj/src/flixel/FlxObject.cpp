...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1100_drawDebug,"flixel.FlxObject","drawDebug",0x2ad45ea0,"flixel.FlxObject.drawDebug","flixel/FlxObject.hx",1100,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1120_drawDebugOnCamera,"flixel.FlxObject","drawDebugOnCamera",0x0b2ef7e4,"flixel.FlxObject.drawDebugOnCamera","flixel/FlxObject.hx",1120,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1131_drawDebugBoundingBox,"flixel.FlxObject","drawDebugBoundingBox",0xa96b1247,"flixel.FlxObject.drawDebugBoundingBox","flixel/FlxObject.hx",1131,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1153_beginDrawDebug,"flixel.FlxObject","beginDrawDebug",0x8677cfb5,"flixel.FlxObject.beginDrawDebug","flixel/FlxObject.hx",1153,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1166_endDrawDebug,"flixel.FlxObject","endDrawDebug",0x2518e603,"flixel.FlxObject.endDrawDebug","flixel/FlxObject.hx",1166,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1216_set_width,"flixel.FlxObject","set_width",0x7d06d55a,"flixel.FlxObject.set_width","flixel/FlxObject.hx",1216,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1230_set_height,"flixel.FlxObject","set_height",0x9f435213,"flixel.FlxObject.set_height","flixel/FlxObject.hx",1230,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1301_set_debugBoundingBoxColorSolid,"flixel.FlxObject","set_debugBoundingBoxColorSolid",0xb8a23688,"flixel.FlxObject.set_debugBoundingBoxColorSolid","flixel/FlxObject.hx",1301,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1307_set_debugBoundingBoxColorNotSolid,"flixel.FlxObject","set_debugBoundingBoxColorNotSolid",0x55ae1bdb,"flixel.FlxObject.set_debugBoundingBoxColorNotSolid","flixel/FlxObject.hx",1307,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1313_set_debugBoundingBoxColorPartial,"flixel.FlxObject","set_debugBoundingBoxColorPartial",0x34746b1e,"flixel.FlxObject.set_debugBoundingBoxColorPartial","flixel/FlxObject.hx",1313,0xf0fe0d80)
...
HXLINE( 625)		this->ignoreDrawDebug = false;
HXLINE( 619)		this->debugBoundingBoxColorPartial = -16744448;
HXLINE( 611)		this->debugBoundingBoxColorNotSolid = -16776961;
HXLINE( 605)		this->debugBoundingBoxColorSolid = -65536;
HXLINE( 599)		this->debugBoundingBoxColor = null();
...
HXLINE( 717)		this->super::update(elapsed);
...
HXLINE( 764)		this->super::draw();
HXLINE( 765)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE( 766)			this->drawDebug();
            		}
            	}
...
void FlxObject_obj::drawDebug(){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1100_drawDebug)
HXLINE(1101)		if (this->ignoreDrawDebug) {
HXLINE(1102)			return;
            		}
HXLINE(1104)		{
HXLINE(1104)			int _g = 0;
HXDLIN(1104)			::Array< ::Dynamic> _g1 = this->get_cameras();
HXDLIN(1104)			while((_g < _g1->length)){
HXLINE(1104)				 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(1104)				_g = (_g + 1);
HXLINE(1106)				this->drawDebugOnCamera(camera);
HXLINE(1108)				bool _hx_tmp;
HXDLIN(1108)				if (::hx::IsNotNull( this->path )) {
HXLINE(1108)					_hx_tmp = !(this->path->ignoreDrawDebug);
            				}
            				else {
HXLINE(1108)					_hx_tmp = false;
            				}
HXDLIN(1108)				if (_hx_tmp) {
HXLINE(1109)					this->path->drawDebug(null());
            				}
            			}
            		}
            	}
...
void FlxObject_obj::drawDebugOnCamera( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1120_drawDebugOnCamera)
HXLINE(1121)		bool _hx_tmp;
HXDLIN(1121)		bool _hx_tmp1;
HXDLIN(1121)		if (camera->visible) {
HXLINE(1121)			_hx_tmp1 = !(camera->exists);
            		}
            		else {
HXLINE(1121)			_hx_tmp1 = true;
            		}
HXDLIN(1121)		if (!(_hx_tmp1)) {
HXLINE(1121)			_hx_tmp = !(this->isOnScreen(camera));
            		}
            		else {
...
HXLINE(1124)		 ::flixel::math::FlxRect rect = this->getBoundingBox(camera);
HXLINE(1125)		 ::openfl::display::Graphics gfx;
HXDLIN(1125)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1125)			::flixel::util::FlxSpriteUtil_obj::flashGfx->clear();
HXDLIN(1125)			gfx = ::flixel::util::FlxSpriteUtil_obj::flashGfx;
            		}
            		else {
HXLINE(1125)			gfx = camera->debugLayer->get_graphics();
            		}
HXLINE(1126)		this->drawDebugBoundingBox(gfx,rect,this->allowCollisions,this->immovable);
HXLINE(1127)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1127)			camera->buffer->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            		}
            	}
...
void FlxObject_obj::drawDebugBoundingBox( ::openfl::display::Graphics gfx, ::flixel::math::FlxRect rect,int allowCollisions,bool partial){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1131_drawDebugBoundingBox)
HXLINE(1133)		 ::Dynamic color = this->debugBoundingBoxColor;
HXLINE(1134)		if (::hx::IsNull( color )) {
HXLINE(1136)			if ((allowCollisions != 0)) {
HXLINE(1138)				if (partial) {
HXLINE(1138)					color = this->debugBoundingBoxColorPartial;
            				}
            				else {
HXLINE(1138)					color = this->debugBoundingBoxColorSolid;
            				}
            			}
            			else {
HXLINE(1142)				color = this->debugBoundingBoxColorNotSolid;
            			}
            		}
HXLINE(1147)		gfx->lineStyle(1,color,((Float)0.5),null(),null(),null(),null(),null());
HXLINE(1148)		gfx->drawRect(rect->x,rect->y,rect->width,rect->height);
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(FlxObject_obj,drawDebugBoundingBox,(void))
 ...
 ::openfl::display::Graphics FlxObject_obj::beginDrawDebug( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1153_beginDrawDebug)
HXDLIN(1153)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1155)			::flixel::util::FlxSpriteUtil_obj::flashGfx->clear();
HXLINE(1156)			return ::flixel::util::FlxSpriteUtil_obj::flashGfx;
            		}
            		else {
HXLINE(1160)			return camera->debugLayer->get_graphics();
            		}
...
void FlxObject_obj::endDrawDebug( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1166_endDrawDebug)
HXDLIN(1166)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1167)			camera->buffer->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            		}
            	}
...
Float FlxObject_obj::set_width(Float Width){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1216_set_width)
HXLINE(1218)		if ((Width < 0)) {
HXLINE(1220)			::flixel::FlxG_obj::log->advanced(HX_("An object's width cannot be smaller than 0. Use offset for sprites to control the hitbox position!",f5,8d,0b,95),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE(1221)			return Width;
            		}
HXLINE(1225)		return (this->width = Width);
            	}
...
Float FlxObject_obj::set_height(Float Height){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1230_set_height)
HXLINE(1232)		if ((Height < 0)) {
HXLINE(1234)			::flixel::FlxG_obj::log->advanced(HX_("An object's height cannot be smaller than 0. Use offset for sprites to control the hitbox position!",b0,49,90,e4),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE(1235)			return Height;
            		}
HXLINE(1239)		return (this->height = Height);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorSolid(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1301_set_debugBoundingBoxColorSolid)
HXDLIN(1301)		return (this->debugBoundingBoxColorSolid = color);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorNotSolid(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1307_set_debugBoundingBoxColorNotSolid)
HXDLIN(1307)		return (this->debugBoundingBoxColorNotSolid = color);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorPartial(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1313_set_debugBoundingBoxColorPartial)
HXDLIN(1313)		return (this->debugBoundingBoxColorPartial = color);
            	}
