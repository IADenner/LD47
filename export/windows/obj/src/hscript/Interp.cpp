...
HXLINE(  62)		{
HXLINE(  62)			 ::Dynamic value = null();
HXDLIN(  62)			this->variables->set(HX_("null",87,9e,0e,49),value);
            		}
...
HXDLIN(  90)			return (( (Float)(_hx_tmp) ) - ( (Float)(me->expr(e2)) ));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN(  91)			return (( (Float)(_hx_tmp) ) * ( (Float)(me->expr(e2)) ));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN(  92)			return (( (Float)(_hx_tmp) ) / ( (Float)(me->expr(e2)) ));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN(  93)			return ::hx::Mod(_hx_tmp,me->expr(e2));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN(  94)			return (( (int)(_hx_tmp) ) & ( (int)(me->expr(e2)) ));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN(  95)			return (( (int)(_hx_tmp) ) | ( (int)(me->expr(e2)) ));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXLINE(  96)			 ::Dynamic _hx_tmp = me->expr(e1);
HXDLIN(  96)			return (( (int)(_hx_tmp) ) ^ ( (int)(me->expr(e2)) ));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN(  97)			return (( (int)(_hx_tmp) ) << ( (int)(me->expr(e2)) ));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN(  98)			return (( (int)(_hx_tmp) ) >> ( (int)(me->expr(e2)) ));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN(  99)			return ::hx::UShr(( (int)(_hx_tmp) ),( (int)(me->expr(e2)) ));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN( 100)			return ::hx::IsEq( _hx_tmp,me->expr(e2) );
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN( 101)			return ::hx::IsNotEq( _hx_tmp,me->expr(e2) );
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN( 102)			return ::hx::IsGreaterEq( _hx_tmp,me->expr(e2) );
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN( 103)			return ::hx::IsLessEq( _hx_tmp,me->expr(e2) );
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN( 104)			return ::hx::IsGreater( _hx_tmp,me->expr(e2) );
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN( 105)			return ::hx::IsLess( _hx_tmp,me->expr(e2) );
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXLINE( 106)			if (::hx::IsNotEq( me->expr(e1),true )) {
HXLINE( 106)				return ::hx::IsEq( me->expr(e2),true );
            			}
            			else {
...
HXLINE( 107)			if (::hx::IsEq( me->expr(e1),true )) {
HXLINE( 107)				return ::hx::IsEq( me->expr(e2),true );
            			}
            			else {
...
HXDLIN( 109)			return  ::IntIterator_obj::__alloc( HX_CTX ,( (int)(_hx_tmp) ),( (int)(me->expr(e2)) ));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXLINE( 114)			return ::hx::Mod(v1,v2);
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXLINE( 120)			return ::hx::UShr(v1,v2);
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN( 134)				 ::hscript::Expr e = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 134)				{
HXLINE( 135)					 ::Dynamic arr = this->expr(e);
HXLINE( 136)					 ::Dynamic index1 = this->expr(index);
HXLINE( 137)					if (::Std_obj::isOfType(arr,( ( ::Dynamic)(::hx::ClassOf< ::haxe::IMap >()) ))) {
...
HXLINE( 141)						arr->__SetItem(( (int)(index1) ),v);
            			...
            			break;
            			default:{
HXLINE( 145)				 ::hscript::Error e = ::hscript::Error_obj::EInvalidOp(HX_("=",3d,00,00,00));
HXDLIN( 145)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            			}
            		}
HXLINE( 147)		return v;
            	}
...
HXLINE( 167)					 ::Dynamic v1 = this->get(obj,f);
HXDLIN( 167)					v = fop(v1,this->expr(e2));
...
HXDLIN( 169)				 ::hscript::Expr e = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 169)				{
HXLINE( 170)					 ::Dynamic arr = this->expr(e);
HXLINE( 171)					 ::Dynamic index1 = this->expr(index);
HXLINE( 172)					if (::Std_obj::isOfType(arr,( ( ::Dynamic)(::hx::ClassOf< ::haxe::IMap >()) ))) {
HXLINE( 173)						 ::Dynamic v1 = ::haxe::IMap_obj::get( ::hx::interface_check(arr,0x09c2bd39),index1);
...
HXLINE( 178)						arr->__SetItem(( (int)(index1) ),v);
            			...
            			break;
            			default:{
HXLINE( 181)				 ::hscript::Error e = ::hscript::Error_obj::EInvalidOp(op);
...
HXLINE( 203)				 ::Dynamic v = this->get(obj,f);
HXLINE( 204)				if (prefix) {
HXLINE( 205)					v = (v + delta);
HXLINE( 206)					this->set(obj,f,v);
            				}
            				else {
HXLINE( 208)					this->set(obj,f,(v + delta));
            				}
HXLINE( 209)				return v;
            			}
            			break;
...
HXDLIN( 210)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 211)				 ::Dynamic arr = this->expr(e1);
HXLINE( 212)				 ::Dynamic index1 = this->expr(index);
HXLINE( 213)				if (::Std_obj::isOfType(arr,( ( ::Dynamic)(::hx::ClassOf< ::haxe::IMap >()) ))) {
HXLINE( 214)					int v = ( (int)(::haxe::IMap_obj::get( ::hx::interface_check(arr,0x09c2bd39),index1)) );
HXLINE( 215)					if (prefix) {
HXLINE( 216)						v = (v + delta);
HXLINE( 217)						::haxe::IMap_obj::set( ::hx::interface_check(arr,0x09c2bd39),index1,v);
            					}
            					else {
HXLINE( 220)						::haxe::IMap_obj::set( ::hx::interface_check(arr,0x09c2bd39),index1,(v + delta));
            					}
HXLINE( 222)					return v;
            				}
            				else {
HXLINE( 225)					int v = ( (int)(arr->__GetItem(( (int)(index1) ))) );
HXLINE( 226)					if (prefix) {
HXLINE( 227)						v = (v + delta);
HXLINE( 228)						arr->__SetItem(( (int)(index1) ),v);
            					}
            					else {
HXLINE( 230)						arr->__SetItem(( (int)(index1) ),(v + delta));
            					}
HXLINE( 231)					return v;
            				}
            			}
...
HXLINE( 234)					e = HX_("++",a0,25,00,00);
            				}
            				else {
HXLINE( 234)					e = HX_("--",60,27,00,00);
            				}
HXDLIN( 234)				 ::hscript::Error e1 = ::hscript::Error_obj::EInvalidOp(e);
HXDLIN( 234)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e1));
            			}
            		}
...
HXLINE( 250)				if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE(   1)					 ::hscript::_Interp::Stop e = _g1;
HXLINE( 253)					switch((int)(e->_hx_getIndex())){
            						case (int)0: {
HXLINE( 254)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid break",b6,ee,24,9d)));
            						}
            						break;
            						case (int)1: {
HXLINE( 255)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid continue",d0,6a,b7,3f)));
            						}
            						break;
            						case (int)2: {
...
HXDLIN( 250)					HX_STACK_DO_THROW(_g);
            				}
            			}
            			else {
...
HXDLIN( 285)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            		}
            		else {
HXDLIN( 285)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            		}
...
HXDLIN( 303)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            		}
HXLINE( 304)		return v;
            	}
...
HXLINE( 323)				return this->resolve(id);
            			...
            			break;
            			case (int)2: {
HXLINE( 324)				 ::hscript::CType _g = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 324)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 327)				return null();
            			...
            			break;
            			case (int)3: {
HXLINE( 328)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 329)				return this->expr(e1);
            			}
            			break;
            			case (int)4: {
HXLINE( 330)				::Array< ::Dynamic> exprs = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 331)				int old = this->declared->length;
HXLINE( 332)				 ::Dynamic v = null();
HXLINE( 333)				{
HXLINE( 333)					int _g = 0;
HXDLIN( 333)					while((_g < exprs->length)){
HXLINE( 333)						 ::hscript::Expr e = exprs->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 333)						_g = (_g + 1);
HXLINE( 334)						v = this->expr(e);
            					}
            				}
...
HXLINE( 336)				return v;
            			...
            			break;
            			case (int)5: {
HXLINE( 337)				::String f = e->_hx_getString(1);
HXDLIN( 337)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 338)				return this->get(this->expr(e1),f);
            			}
            			break;
            			case (int)6: {
HXLINE( 339)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 339)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXLINE( 342)				return fop(e1,e2);
            			}
            			break;
            			case (int)7: {
HXLINE( 343)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 343)				bool prefix = e->_hx_getBool(1);
HXDLIN( 343)				::String op = e->_hx_getString(0);
HXLINE( 344)				::String _hx_switch_0 = op;
            				if (  (_hx_switch_0==HX_("!",21,00,00,00)) ){
HXLINE( 346)					return ::hx::IsNotEq( this->expr(e1),true );
HXDLIN( 346)					goto _hx_goto_50;
            				}
            				if (  (_hx_switch_0==HX_("++",a0,25,00,00)) ){
HXLINE( 350)					return this->increment(e1,prefix,1);
HXDLIN( 350)					goto _hx_goto_50;
            				}
            				if (  (_hx_switch_0==HX_("-",2d,00,00,00)) ){
HXLINE( 348)					return -(this->expr(e1));
HXDLIN( 348)					goto _hx_goto_50;
            				}
            				if (  (_hx_switch_0==HX_("--",60,27,00,00)) ){
HXLINE( 352)					return this->increment(e1,prefix,-1);
HXDLIN( 352)					goto _hx_goto_50;
            				}
            				if (  (_hx_switch_0==HX_("~",7e,00,00,00)) ){
HXLINE( 357)					return ~(( (int)(this->expr(e1)) ));
HXDLIN( 357)					goto _hx_goto_50;
            				}
            				/* default */{
HXLINE( 360)					 ::hscript::Error e = ::hscript::Error_obj::EInvalidOp(op);
HXDLIN( 360)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            				}
            				_hx_goto_50:;
            			}
            			break;
...
HXDLIN( 362)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 363)				::cpp::VirtualArray args = ::cpp::VirtualArray_obj::__new();
HXLINE( 364)				{
HXLINE( 364)					int _g = 0;
HXDLIN( 364)					while((_g < params->length)){
HXLINE( 364)						 ::hscript::Expr p = params->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 364)						_g = (_g + 1);
HXLINE( 365)						args->push(this->expr(p));
            					}
            				}
HXLINE( 367)				if ((e1->_hx_getIndex() == 5)) {
HXLINE( 368)					::String f = e1->_hx_getString(1);
HXDLIN( 368)					 ::hscript::Expr e = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 369)					 ::Dynamic obj = this->expr(e);
HXLINE( 370)					if (::hx::IsNull( obj )) {
HXLINE( 370)						 ::hscript::Error e = ::hscript::Error_obj::EInvalidAccess(f);
HXDLIN( 370)						HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            					}
HXLINE( 371)					return this->fcall(obj,f,args);
            				}
            				else {
HXLINE( 373)					return this->call(null(),this->expr(e1),args);
            				}
            			}
            			break;
            			case (int)9: {
HXLINE( 375)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 375)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 375)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 376)				if (::hx::IsEq( this->expr(econd),true )) {
HXLINE( 376)					return this->expr(e1);
            				}
            				else {
HXLINE( 376)					if (::hx::IsNull( e2 )) {
HXLINE( 376)						return null();
            					}
            					else {
HXLINE( 376)						return this->expr(e2);
            					}
            				}
            			}
            			break;
            			case (int)10: {
HXLINE( 377)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 377)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 378)				this->whileLoop(econd,e1);
HXLINE( 379)				return null();
            			}
            			break;
            			case (int)11: {
HXLINE( 383)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 383)				 ::hscript::Expr it = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 383)				::String v = e->_hx_getString(0);
HXLINE( 384)				this->forLoop(v,it,e1);
HXLINE( 385)				return null();
            			}
            			break;
            			case (int)12: {
HXLINE( 387)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::_Interp::Stop_obj::SBreak_dyn()));
            			}
            			break;
            			case (int)13: {
HXLINE( 389)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::_Interp::Stop_obj::SContinue_dyn()));
            			}
            			break;
            			case (int)14: {
...
HXLINE( 403)					if ((args->get_length() != params->length)) {
HXLINE( 404)						if ((args->get_length() < minParams)) {
HXLINE( 405)							::String str = (((HX_("Invalid number of parameters. Got ",cb,2b,d9,b1) + args->get_length()) + HX_(", required ",ed,0c,66,93)) + minParams);
HXLINE( 406)							if (::hx::IsNotNull( name )) {
HXLINE( 406)								str = (str + ((HX_(" for function '",f6,90,ab,a0) + name) + HX_("'",27,00,00,00)));
            							}
HXLINE( 407)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(str));
            						}
HXLINE( 410)						::cpp::VirtualArray args2 = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 411)						int extraParams = (args->get_length() - minParams);
HXLINE( 412)						int pos = 0;
HXLINE( 413)						{
HXLINE( 413)							int _g = 0;
HXDLIN( 413)							while((_g < params->length)){
HXLINE( 413)								 ::Dynamic p = params->__get(_g);
HXDLIN( 413)								_g = (_g + 1);
HXLINE( 414)								if (( (bool)(p->__Field(HX_("opt",33,9c,54,00),::hx::paccDynamic)) )) {
HXLINE( 415)									if ((extraParams > 0)) {
HXLINE( 416)										pos = (pos + 1);
HXDLIN( 416)										args2->push(args->__get((pos - 1)));
...
HXDLIN( 421)									args2->push(args->__get((pos - 1)));
            								}
            							}
            						}
HXLINE( 422)						args = args2;
            					}
HXLINE( 424)					 ::haxe::ds::StringMap old = me->locals;
HXDLIN( 424)					int depth = me->depth;
HXLINE( 425)					me->depth++;
HXLINE( 426)					me->locals = me->duplicate(capturedLocals);
HXLINE( 427)					{
HXLINE( 427)						int _g = 0;
HXDLIN( 427)						int _g1 = params->length;
HXDLIN( 427)						while((_g < _g1)){
HXLINE( 427)							_g = (_g + 1);
HXDLIN( 427)							int i = (_g - 1);
HXLINE( 428)							me->locals->set(( (::String)(params->__get(i)->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) ), ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 434)								me->locals = old;
HXLINE( 435)								me->depth = depth;
HXLINE( 439)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            							}
            							else {
            								HX_STACK_DO_THROW(_hx_e);
            							}
...
HXLINE( 444)					me->locals = old;
HXLINE( 445)					me->depth = depth;
HXLINE( 446)					return r;
            				}
            				HX_END_LOCAL_FUNC1(return)

HXLINE( 393)				 ::hscript::CType _g = e->_hx_getObject(3).StaticCast<  ::hscript::CType >();
HXDLIN( 393)				::String name = e->_hx_getString(2);
HXDLIN( 393)				 ::hscript::Expr fexpr = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 393)				::Array< ::Dynamic> params = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXDLIN( 397)					while((_g1 < params->length)){
HXLINE( 397)						 ::Dynamic p = params->__get(_g1);
HXDLIN( 397)						_g1 = (_g1 + 1);
HXLINE( 398)						if (( (bool)(p->__Field(HX_("opt",33,9c,54,00),::hx::paccDynamic)) )) {
...
HXLINE( 402)				 ::Dynamic f =  ::Dynamic(new _hx_Closure_0(name,fexpr,_gthis,minParams,me,params,capturedLocals));
HXLINE( 448)				 ::Dynamic f1 = ::Reflect_obj::makeVarArgs(f);
HXLINE( 449)				if (::hx::IsNotNull( name )) {
HXLINE( 450)					if ((this->depth == 0)) {
HXLINE( 452)						this->variables->set(name,f1);
            					}
            					else {
HXLINE( 455)						::Array< ::Dynamic> _hx_tmp = this->declared;
HXDLIN( 455)						::String name1 = name;
HXDLIN( 455)						_hx_tmp->push( ::Dynamic(::hx::Anon_obj::Create(2)
...
HXLINE( 461)				return f1;
            			}
            			break;
            			case (int)15: {
HXLINE( 390)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 391)				 ::Dynamic _hx_tmp;
HXDLIN( 391)				if (::hx::IsNull( e1 )) {
HXLINE( 391)					_hx_tmp = null();
            				}
            				else {
HXLINE( 391)					_hx_tmp = this->expr(e1);
            				}
HXDLIN( 391)				this->returnValue = _hx_tmp;
HXLINE( 392)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::_Interp::Stop_obj::SReturn_dyn()));
            			}
            			break;
            			case (int)16: {
HXLINE( 504)				 ::hscript::Expr index = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 504)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 505)				 ::Dynamic arr = this->expr(e1);
HXLINE( 506)				 ::Dynamic index1 = this->expr(index);
HXLINE( 507)				if (::Std_obj::isOfType(arr,( ( ::Dynamic)(::hx::ClassOf< ::haxe::IMap >()) ))) {
...
HXLINE( 511)					return arr->__GetItem(( (int)(index1) ));
            			...
            			break;
            			case (int)17: {
HXLINE( 462)				::Array< ::Dynamic> arr = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 463)				bool _hx_tmp;
HXDLIN( 463)				if ((arr->length > 0)) {
HXLINE( 463)					 ::hscript::Expr _g = arr->__get(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 463)					if ((_g->_hx_getIndex() == 6)) {
HXLINE( 463)						 ::hscript::Expr _g1 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 463)						 ::hscript::Expr _g2 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 463)						if ((_g->_hx_getString(0) == HX_("=>",61,35,00,00))) {
...
HXLINE( 470)					{
HXLINE( 470)						int _g = 0;
HXDLIN( 470)						while((_g < arr->length)){
HXLINE( 470)							 ::hscript::Expr e = arr->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 470)							_g = (_g + 1);
HXLINE( 471)							if ((e->_hx_getIndex() == 6)) {
HXLINE( 472)								if ((e->_hx_getString(0) == HX_("=>",61,35,00,00))) {
HXLINE( 472)									 ::hscript::Expr eValue = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 472)									 ::hscript::Expr eKey = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 472)									{
HXLINE( 473)										 ::Dynamic key = this->expr(eKey);
HXLINE( 474)										 ::Dynamic value = this->expr(eValue);
HXLINE( 475)										if (isAllString) {
HXLINE( 475)											isAllString = ::Std_obj::isOfType(key,( ( ::Dynamic)(::hx::ClassOf< ::String >()) ));
            										}
            										else {
HXLINE( 475)											isAllString = false;
            										}
HXLINE( 476)										if (isAllInt) {
HXLINE( 476)											isAllInt = ::Std_obj::isOfType(key,( ( ::Dynamic)(::hx::ClassOf< int >()) ));
            										}
            										else {
...
HXLINE( 480)										values->push(value);
            									}
            								}
            								else {
HXLINE( 482)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("=> expected",17,e5,65,e5)));
            								}
            							}
            							else {
HXLINE( 482)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("=> expected",17,e5,65,e5)));
...
HXLINE( 490)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Inconsistent key types",af,4f,50,a9)));
            								}
            							}
            						}
            					}
...
HXDLIN( 492)						int _g2 = keys->get_length();
HXDLIN( 492)						while((_g1 < _g2)){
HXLINE( 492)							_g1 = (_g1 + 1);
HXDLIN( 492)							int n = (_g1 - 1);
HXLINE( 493)							::haxe::IMap_obj::set( ::hx::interface_check(map,0x09c2bd39),keys->__get(n),values->__get(n));
            						}
            					}
...
HXLINE( 499)					{
HXLINE( 499)						int _g = 0;
HXDLIN( 499)						while((_g < arr->length)){
HXLINE( 499)							 ::hscript::Expr e = arr->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 499)							_g = (_g + 1);
HXLINE( 500)							a->push(this->expr(e));
            						}
            					}
HXLINE( 502)					return a;
            				}
            			...
            			break;
            			case (int)18: {
HXLINE( 513)				::Array< ::Dynamic> params = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 513)				::String cl = e->_hx_getString(0);
HXLINE( 514)				::cpp::VirtualArray a = ::cpp::VirtualArray_obj::__new();
HXLINE( 515)				{
HXLINE( 515)					int _g = 0;
HXDLIN( 515)					while((_g < params->length)){
HXLINE( 515)						 ::hscript::Expr e = params->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 515)						_g = (_g + 1);
HXLINE( 516)						a->push(this->expr(e));
            					}
            				}
HXLINE( 517)				return this->cnew(cl,a);
            			}
            			break;
            			case (int)19: {
HXLINE( 518)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 519)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(this->expr(e1)));
            			}
            			break;
            			case (int)20: {
HXLINE( 520)				 ::hscript::CType _g = e->_hx_getObject(2).StaticCast<  ::hscript::CType >();
HXDLIN( 520)				 ::hscript::Expr ecatch = e->_hx_getObject(3).StaticCast<  ::hscript::Expr >();
HXDLIN( 520)				::String n = e->_hx_getString(1);
HXDLIN( 520)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 521)				int old = this->declared->length;
HXLINE( 522)				bool oldTry = this->inTry;
HXLINE( 523)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 524)					this->inTry = true;
HXLINE( 525)					 ::Dynamic v = this->expr(e1);
...
HXDLIN(   1)						 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 523)						if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE(   1)							 ::hscript::_Interp::Stop err = _g1;
HXLINE( 530)							this->inTry = oldTry;
HXLINE( 531)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(err));
            						}
            						else {
HXLINE(   1)							 ::Dynamic err = _g1;
HXLINE( 534)							this->restore(old);
HXLINE( 535)							this->inTry = oldTry;
HXLINE( 537)							::Array< ::Dynamic> _hx_tmp = this->declared;
HXDLIN( 537)							_hx_tmp->push( ::Dynamic(::hx::Anon_obj::Create(2)
            								->setFixed(0,HX_("n",6e,00,00,00),n)
            								->setFixed(1,HX_("old",a7,98,54,00),this->locals->get(n))));
HXLINE( 538)							this->locals->set(n, ::Dynamic(::hx::Anon_obj::Create(1)
            								->setFixed(0,HX_("r",72,00,00,00),err)));
HXLINE( 539)							 ::Dynamic v = this->expr(ecatch);
HXLINE( 540)							this->restore(old);
HXLINE( 541)							return v;
            						}
            					}
            					else {
...
HXLINE( 545)				{
HXLINE( 545)					int _g = 0;
HXDLIN( 545)					while((_g < fl->length)){
HXLINE( 545)						 ::Dynamic f = fl->__get(_g);
HXDLIN( 545)						_g = (_g + 1);
HXLINE( 546)						::String f1 = ( (::String)(f->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) );
HXDLIN( 546)						this->set(o,f1,this->expr(f->__Field(HX_("e",65,00,00,00),::hx::paccDynamic)));
            					}
            				}
HXLINE( 547)				return o;
            			}
            			break;
            			case (int)22: {
HXLINE( 548)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 548)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 548)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 549)				if (::hx::IsEq( this->expr(econd),true )) {
HXLINE( 549)					return this->expr(e1);
            				}
            				else {
HXLINE( 549)					return this->expr(e2);
            				}
            			}
            			break;
            			case (int)23: {
...
HXDLIN( 550)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 551)				 ::Dynamic val = this->expr(e1);
HXLINE( 552)				bool match = false;
HXLINE( 553)				{
HXLINE( 553)					int _g = 0;
HXDLIN( 553)					while((_g < cases->length)){
HXLINE( 553)						 ::Dynamic c = cases->__get(_g);
HXDLIN( 553)						_g = (_g + 1);
HXLINE( 554)						{
HXLINE( 554)							int _g1 = 0;
HXDLIN( 554)							::Array< ::Dynamic> _g2 = ( (::Array< ::Dynamic>)(c->__Field(HX_("values",e2,03,b7,4f),::hx::paccDynamic)) );
HXDLIN( 554)							while((_g1 < _g2->length)){
HXLINE( 554)								 ::hscript::Expr v = _g2->__get(_g1).StaticCast<  ::hscript::Expr >();
HXDLIN( 554)								_g1 = (_g1 + 1);
HXLINE( 555)								if (::hx::IsEq( this->expr(v),val )) {
...
HXLINE( 559)						if (match) {
HXLINE( 560)							val = this->expr(c->__Field(HX_("expr",35,fd,1d,43),::hx::paccDynamic));
...
HXLINE( 566)				return val;
            			...
            			break;
            			case (int)24: {
HXLINE( 380)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 380)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 381)				this->doWhileLoop(econd,e1);
HXLINE( 382)				return null();
            			}
            			break;
            			case (int)25: {
HXLINE( 567)				::Array< ::Dynamic> _g = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 567)				::String _g1 = e->_hx_getString(0);
HXDLIN( 567)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 568)				return this->expr(e1);
            			}
            			break;
            			case (int)26: {
HXLINE( 569)				 ::hscript::CType _g = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 569)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 570)				return this->expr(e1);
            			}
            			break;
            		}
...
HXDLIN(   1)					 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 578)					if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE(   1)						 ::hscript::_Interp::Stop err = _g1;
...
HXLINE( 583)								goto _hx_goto_64;
            							...
            							break;
            							case (int)2: {
HXLINE( 584)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(err));
            							}
            							break;
            						}
            					}
            					else {
HXLINE( 578)						HX_STACK_DO_THROW(_g);
            					}
            				}
            				else {
            					HX_STACK_DO_THROW(_hx_e);
...
HXDLIN(   1)					 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 595)					if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE(   1)						 ::hscript::_Interp::Stop err = _g1;
...
HXLINE( 600)								goto _hx_goto_66;
            							...
            							break;
            							case (int)2: {
HXLINE( 601)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(err));
            							}
            							break;
            						}
            					}
            					else {
HXLINE( 595)						HX_STACK_DO_THROW(_g);
            					}
            				}
            				else {
            					HX_STACK_DO_THROW(_hx_e);
...
HXLINE( 614)			 ::hscript::Error e = ::hscript::Error_obj::EInvalidIterator(v);
HXDLIN( 614)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            		}
HXLINE( 615)		return v;
            	}
...
HXDLIN(   1)					 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 624)					if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE(   1)						 ::hscript::_Interp::Stop err = _g1;
...
HXLINE( 629)								goto _hx_goto_69;
            							...
            							break;
            							case (int)2: {
HXLINE( 630)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(err));
            							}
            							break;
            						}
            					}
            					else {
HXLINE( 624)						HX_STACK_DO_THROW(_g);
            					}
            				}
            				else {
            					HX_STACK_DO_THROW(_hx_e);
...
HXDLIN( 638)		return ::Std_obj::isOfType(o,( ( ::Dynamic)(::hx::ClassOf< ::haxe::IMap >()) ));
            	}
...
HXDLIN( 650)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            		}
...
HXDLIN( 666)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            		}
