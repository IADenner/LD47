...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("OraclesQuest", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("OraclesQuest", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "OraclesQuest";
		app.meta["name"] = "OraclesQuest";
